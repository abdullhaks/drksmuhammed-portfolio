    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          >
            <motion.div
              className="bg-gradient-to-br from-blue-50/80 to-cyan-50/80 backdrop-blur-sm rounded-3xl p-10 shadow-xl border border-white/50"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    ...
                    {field.type === 'textarea' ? (
                      <motion.textarea
                        ...
                        rows={field.rows}
                        className="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/80 backdrop-blur-sm resize-none"
                      ...
                      <motion.input
                        ...
                        value={formData[field.name]}
                        onChange={handleInputChange}
                        className="w-full px-5 py-4 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/80 backdrop-blur-sm"
                        placeholder={field.placeholder}
                        whileFocus={{ scale: 1.02, boxShadow: "0 10px 30px rgba(59, 130, 246, 0.1)" }}
                      />
                    )}
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-4 px-8 rounded-2xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center space-x-3 font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                >
                  {isSubmitting ? (
                    <motion.div 
          ...
          >
                ...
                {[
                  ...
                  <a key={index} href={item.link}>
                    <motion.div
                      ...
                      className="flex items-center space-x-6 p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-white/50 cursor-pointer group transition-all duration-300"
                    >
                      <motion.div 
                        className={`w-16 h-16 ${item.bgColor} rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300`}
                      ...
                      <div className="flex-1">
                        <motion.p 
                          className="font-semibold text-gray-900 text-lg group-hover:text-blue-600 transition-colors"
                          whileHover={{ x: 5 }}
                        >
                          {item.label}
                        </motion.p>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-green-50/80 to-emerald-50/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 group cursor-pointer"
            >
              <motion.h4 
              ...
              <motion.p 
                ...
                whileHover={{ x: 5 }}
              >
                Schedule your personalized homeopathic consultation from the comfort of your home. 
                Available for patients worldwide with flexible timing options.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <span className="font-semibold">Trusted by {patients}+ patients globally</span>
              </motion.div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 group cursor-pointer"
            >
              <motion.h4 
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    >
                      <CheckCircle className="w-5 h-5 text-blue-600 group-hover/item:text-green-600 transition-colors" />
                    </motion.div>
